...
%
%   >> validate_against_simpy                      % uses simpy_results.json beside this file
%   >> validate_against_simpy('path/to/results.json')

function validate_against_simpy(jsonPath)
if nargin < 1, jsonPath = fullfile(fileparts(mfilename('fullpath')), 'simpy_results.json'); end
